...
```{autoclass} djangocms_structured_data.mixins.CategoryMixin
:members:
:undoc-members:
```
...
```{autoclass} djangocms_structured_data.mixins.CategoryFormMixin
:members:
:undoc-members:
```
...
```{autoclass} djangocms_structured_data.mixins.CategoryAdminMixin
:members:
:undoc-members:
```
